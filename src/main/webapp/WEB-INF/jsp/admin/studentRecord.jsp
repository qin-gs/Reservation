        ...
        <div class="col-sm-10">
            <div class="form-inline">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="输入学号" id="studentId" value="${studentId}">
                </div>
                <div class="form-group">
                    <button class="btn btn-default" onclick="studentRecord()">筛选记录</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    function geturl(page) {
        window.location.href = "/admin/" + $('#studentId').val() + "/studentRecord?pageNo=" + page;
    }

    function exportData() {
        var studentId = $('#studentId').val();
        $.ajax({
            url: "/admin/" + studentId + "/exportStudentData",
            type: "POST",
            async: false,
