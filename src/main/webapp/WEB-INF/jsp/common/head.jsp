    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" id="company_logo" href="#">学生系统</a>
            </div>

            <div class="collapse navbar-collapse" id="hrms-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="#">机房预约 <span class="sr-only">(current)</span> </a>
                    </li>
                    <li><a href="#" onclick="introduce()">机房介绍</a></li>
                    <li><a href="#" onclick="appoint_rule()">预约规则</a></li>
                </ul>
...
<script type="text/javascript">
    ...
    $("#company_logo").click(function () {
        $(this).attr("href", "/reservation/main");
    });
    //账号退出
    ...
    function introduce() {
        window.location.href = "/reservation/introduce";
    }

    function appoint_rule() {
        window.location.href = "/reservation/rule";
    }
</script>
</body>
</html>
